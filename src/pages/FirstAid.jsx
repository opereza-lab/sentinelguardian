...
const content = {
  ...
  zh: {
    ...
    cases: [
      { id: "gunshot", color: "text-red-500", border: "border-red-500/40", bg: "bg-red-500/10", urgency: "生死攸关", title: "枪伤", steps: ["先控制出血：用手边任何物品直接加压。", "四肢：在伤口上方5-7厘米处施加止血带。记录时间。", "胸/腹：不用止血带。直接加压。", "不要试图取出子弹。", "胸部伤口：用塑料封住三侧。", "让伤者保持温暖并躺下。", "监测呼吸道。", "不停和伤者说话保持清醒。"], note: "止血带使用不当可能导致截肢。没有它，大出血3-5分钟内致命。" },
