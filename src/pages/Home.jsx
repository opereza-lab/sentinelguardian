...
const content = {
  es: {
    ...
    modules: [
      ...
      { icon: Map, title: "Mapas Sin Conexión", desc: "Tu ubicación GPS y mapas disponibles sin internet.", page: "OfflineMaps", color: "text-green-400" },
  ...
  en: {
    ...
    modules: [
      ...
      { icon: Map, title: "Offline Maps", desc: "Your GPS location and maps available without internet.", page: "OfflineMaps", color: "text-green-400" },
  ...
  fr: {
    ...
    modules: [
      ...
      { icon: Map, title: "Cartes Hors Ligne", desc: "Votre position GPS et cartes disponibles sans internet.", page: "OfflineMaps", color: "text-green-400" },
  ...
  pt: {
    ...
    modules: [
      ...
      { icon: Map, title: "Mapas Offline", desc: "Sua localização GPS e mapas disponíveis sem internet.", page: "OfflineMaps", color: "text-green-400" },
  ...
  it: {
    ...
    modules: [
      ...
      { icon: Map, title: "Mappe Offline", desc: "La tua posizione GPS e mappe disponibili senza internet.", page: "OfflineMaps", color: "text-green-400" },
  ...
  ar: {
    ...
    modules: [
      ...
      { icon: Map, title: "خرائط أوفلاين", desc: "موقعك GPS والخرائط متاحة بدون إنترنت.", page: "OfflineMaps", color: "text-green-400" },
  ...
  zh: {
    ...
    modules: [
      ...
      { icon: Flame, title: "求生火", desc: "在任何情况下如何点燃和维持火焰。", page: "Fire", color: "text-orange-500" },
      { icon: Map, title: "离线地图", desc: "无需网络即可使用您的GPS位置和地图。", page: "OfflineMaps", color: "text-green-400" },
